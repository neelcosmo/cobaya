...
from cobaya.likelihoods.base_classes import BAO_CAMB

"""
# DESI ShapeFit-BAO likelihoods
...
- **desi_2024_bao_lrg_z3**: LRG, 0.8 < z < 1.1
...
class desi_2024_base(BAO_CAMB):
    _is_abstract = True
    bibtex_file = 'desi_2024_bao.bibtex'


class desi_2024_shapefitbao_all_camb(desi_2024_base):
    r"""
